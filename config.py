...
BUSYNESS_MULTIPLIER = 1  # 1 means normal busy-ness, 0.5 means half as busy, etc.
...
STATE_ETD = 'ETD'  # 'STA' | 'ETD'  # STA = stops till available, ETD = estimated time to destination (=ETA)
